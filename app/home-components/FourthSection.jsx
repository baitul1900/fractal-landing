      ...
      <div className="hidden lg:block w-full">
        ...
        >
          <div className="container mx-auto px-6 md:px-10 lg:px-16 h-full pb-10 md:pb-20 pb-safe grid grid-cols-1 md:grid-cols-12 gap-6">
            ...
            >
              <TattooHeading className="text-4xl font-[var(--font-founders)] uppercase leading-0 text-end font-medium">
                Eliezer Costa
              </TattooHeading>
            ...
            >
              <TattooHeading className="text-4xl font-[var(--font-founders)] uppercase leading-0 text-start font-medium">
                NANOOK
              </TattooHeading>
              ...
              <div className="flex justify-end">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="mt-[12px] text-black text-xl font-normal font-[var(--font-founders)] leading-6 underline cursor-pointer"
                >
                  @NANOOK.TTT
                </a>
              </div>
