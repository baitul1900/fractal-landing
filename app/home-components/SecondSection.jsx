    ...
    <SectionWrapper className="mt-[60px] pt-[149px] second-section relative">
      ...
      <div className="absolute top-0 left-0 w-full h-full pointer-events-none z-10 flex flex-col items-center">
        <div className="absolute left-[8%] top-[500px] w-[140px] md:w-[180px] h-[220px] md:h-[260px] opacity-90">
          <Image src={randomImages} alt="Tattoo" fill sizes="(max-width: 768px) 140px, 180px" className="object-cover" />
        </div>
        <div className="absolute left-[35%] top-[750px] w-[150px] md:w-[200px] h-[220px] md:h-[280px] opacity-90">
          <Image src={randomImages} alt="Tattoo" fill sizes="(max-width: 768px) 150px, 200px" className="object-cover" />
        </div>
        <div className="absolute right-[25%] top-[600px] w-[160px] md:w-[210px] h-[240px] md:h-[300px] opacity-90">
          <Image src={randomImages} alt="Tattoo" fill sizes="(max-width: 768px) 160px, 210px" className="object-cover" />
        </div>
        <div className="absolute right-[5%] top-[900px] w-[130px] md:w-[170px] h-[200px] md:h-[250px] opacity-90">
          <Image src={randomImages} alt="Tattoo" fill sizes="(max-width: 768px) 130px, 170px" className="object-cover" />
        </div>
        <div className="absolute left-[20%] top-[1100px] w-[180px] md:w-[230px] h-[250px] md:h-[320px] opacity-90">
          <Image src={randomImages} alt="Tattoo" fill sizes="(max-width: 768px) 180px, 230px" className="object-cover" />
        </div>
        ...
        <div className="absolute left-[33%] top-[1600px] w-[160px] md:w-[200px] h-[230px] md:h-[280px] opacity-90">
          <Image src={randomImages} alt="Tattoo" fill sizes="(max-width: 768px) 160px, 200px" className="object-cover" />
        </div>
        
        {/* Reservation Button */}
        <div className="absolute bottom-[400px] w-full flex justify-center pointer-events-auto">
          <a href="#reservation" className="group flex items-center justify-center gap-3 text-white font-bold uppercase w-fit z-30">
            <div className="pb-1 border-b border-white flex items-center gap-3 transition-all group-hover:gap-5">
              ...
              <span className="text-sm tracking-[0.2em] font-[var(--font-founders)]">RESERVATION</span>
            </div>
          </a>
        </div>
      </div>
