...
const CustomFooter = () => {
  ...
  return (
    <footer className="custom-footer w-full h-auto min-h-[600px] lg:h-[1050px] px-6 md:px-10 lg:px-16 relative font-[var(--font-founders)] py-4 lg:py-0">
