...
const SixthSection = () => {
  const archives = [
    {
      ...
      age: 26,
      quote: "Choosing FRACTAL was a turning point. Their attention to detail and deep understanding of my story resulted in a piece that feels truly personal.",
      image: tattooImg,
    },
    {
      id: 2,
  ...
  return (
    <section id="section-six" className="bg-[#050505] text-white w-full pt-[45px] pb-16 md:pb-24 h-auto px-6 md:px-10 lg:px-16" style={{ background: '#0a0a0a' }}>
      <div className="container mx-auto max-w-[1440px]">
        <h2
          className="text-white text-[32px] font-semibold leading-[38px] mb-10 text-left font-[var(--font-founders)]"
        >
          Body Archives
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {archives.map((item) => (
            ...
            >
              ...
              <div className="absolute inset-x-0 bottom-0 bg-[#161616] p-6 lg:p-8 flex flex-col justify-start transform translate-y-[101%] transition-transform duration-[700ms] ease-[cubic-bezier(0.23,1,0.32,1)] group-hover:translate-y-0 w-full h-full z-10 border border-[#222] rounded-2xl">
                {/* Author Info Top */}
                ...
                {/* Quote details */}
                <p
                  className="text-white/80 text-[15px] md:text-[16px] leading-[24px] font-normal will-change-transform font-[var(--font-founders)]"
                >
                  "{item.quote}"
                </p>
              </div>
